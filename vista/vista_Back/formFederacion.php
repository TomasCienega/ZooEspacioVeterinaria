...
<head>
    ...
    <title>Form Federación</title>
    <!-- Hoja de estilos personalizada -->
    <link
    rel="stylesheet"
    href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"
    />
    <link rel="stylesheet" href="../css/css_back/formFederacion.css">
...
<body>
    ...
    <form action="../../Controlador/agregarNoticiaController.php" method="post" enctype="multipart/form-data">
        <div class="noticias">
            <div class="txt_form">
                <label for="">Imagen: </label>
                <br>
                <input type="file" name="imgN" id="imgN" multiple require>
            </div>
            <div class="txt_form">
            ...
            <div class="txt_form">
                ...
                <textarea name="infoF" id="" cols="30" rows="10"></textarea>
            </div>
        </div>
