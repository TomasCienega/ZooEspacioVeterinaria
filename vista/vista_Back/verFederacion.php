<?php
    include('../../Controlador/listarNoticiaController.php');
    session_start();
...
<head>
    ...
    <title>Tarjeta Federación</title>
    <!-- Hoja de estilos personalizada -->
    <link
    rel="stylesheet"
    href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"
    />
    <link rel="stylesheet" href="../css/css_back/verFederacion.css">
...
<body>
                     ...
                     echo'        
                         ...
                         <div class="cuadro__hijo">
                             ...
                             <ul class="mascPeL">
                                 ...
                                 onclick="eliminar_noticia('.$filaNoticia['id_evento'].');">Eliminar</button>
                             </ul>
                         </div>';
                 }
            ?>
    ...
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
     <script src="../../js/eliminarNoticia.js"></script>
